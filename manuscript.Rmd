...
1.  Learn how to use *visualizemi* to analyze multi-group confirmatory factor analysis, examine partial for invariance, and create visualizations of parameters.
...
8)  `group.equal`: The equality constraints including in your original multi-group tests.
...
load("manu_data/fig-chinese-rs2.Rdata")
complete
```

```{r rs14-chinese-effect-pic, fig.width = 6, include = T, fig.cap = "Effect size differences for item intercepts on the English versus Chinese samples for the RS14.", warnings = FALSE, message = FALSE}
