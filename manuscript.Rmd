...
```{r rs7-img, echo = F, include = T, size = "small", fig.cap="RS7 item non-invariance visualization showing differences in the item intercepts and latent variable."}
# plot the image for RS7
plot_mi(
  data_coef = partial.rs.2$model_coef, 
  model_step = "intercepts", 
...
```{r rs6-img, echo = F, include = T, size = "small", fig.cap="RS6 item non-invariance visualization similar results to RS7 with differences in item intercepts."}
plot_mi(
  data_coef = partial.rs.2$model_coef, 
  model_step = "intercepts", 
  item_name = "RS6", 
